...
実行:
    python3 follow_distance_rgb_gpio_v8_4c.py
"""
...
PREVIEW_WINDOW_NAME = "Presentation Escort V8.4C"
...
def main() -> None:
    ...
    print(
        "Presentation Escort Auto Follow V8.4C"
    )
    print(
        ...
        while True:
            ...
            if face is None:
                ...
                if esp32.active_body in (
                    ...
                    desired_rgb = "RGB_YELLOW"

                elif distance_state == "FAR":
                    desired_rgb = "RGB_BLUE"

                elif distance_state == "NEAR":
                    desired_rgb = "RGB_RED"

                else:
                    desired_rgb = "RGB_GREEN"

                if rgb_status.set(
                    esp32,
                    desired_rgb,
                ):
                    rgb_mode = desired_rgb
