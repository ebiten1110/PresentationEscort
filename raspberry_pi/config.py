...
## config.pyへ追加するV8.3設定例

# 距離判定
DISTANCE_FAR_ENTER_RATIO = 0.24
DISTANCE_FAR_EXIT_RATIO = 0.26

DISTANCE_NEAR_ENTER_RATIO = 0.34
DISTANCE_NEAR_EXIT_RATIO = 0.31

DISTANCE_SMOOTHING_FRAMES = 5
DISTANCE_CONFIRM_FRAMES = 3

# 実際に前進・後退させる
DISTANCE_MOVEMENT_ENABLED = True

# 前後移動を許可する左右中心範囲
DISTANCE_MOVE_MAX_X = 55

# 連続パルス安全上限
MAX_CONSECUTIVE_DISTANCE_PULSES = 4

# TRACK_FORWARDとTRACK_BACKWARDが実機で逆ならTrue
